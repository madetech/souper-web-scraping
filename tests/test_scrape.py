...
import responses
import requests
url = 'https://www.gov.uk/service-standard-reports/get-security-clearance'
# url = ''
...
def test_report_parses(register_response):
...
def test_specific_report(register_response):
    assert get_report_info('https://www.gov.uk/service-standard-reports/get-security-clearance')["Assessment date:"] == '23 March 2022'
